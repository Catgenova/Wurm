...
export const BINDS: BindDef[] = [
  ...
  { id: 'turn_left', label: 'Turn the view left', hint: 'A quarter turn. The compass shows where north went.', group: 'Moving the view', keys: ['KeyQ'] },
  { id: 'turn_right', label: 'Turn the view right', hint: 'A quarter turn the other way.', group: 'Moving the view', keys: ['KeyE'] },
