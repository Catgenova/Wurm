...
export const FURNITURE: FurnitureDef[] = [
  ...
  piece('bed', 'Bed', 3, 2, [['plank', 6], ['timber', 4], ['cotton', 2], ['nail', 20]], 18, 15, 'You nail up a bed and stuff the mattress.'),
  piece('cot', 'Cot', 2, 2, [['plank', 4], ['timber', 2], ['cotton', 1], ['nail', 12]], 12, 10, 'You nail up a narrow cot.'),
