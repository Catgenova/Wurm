...
export const MATERIALS: MaterialDef[] = [
  ...
  { id: 'cobblestone', name: 'Cobblestone', kind: 'stone', tool: 'trowel', skill: 'masonry', color: [140, 136, 128], trim: [92, 88, 82], floor: [126, 122, 116], courses: 4, bill: [['rock_shards', 5]], storeys: 6, heft: 2 },
