...
export const ITEM_DEFS: Record<string, ItemDef> = {
  ...
  gem: { name: 'Gem', category: 'material', weight: 0.05, stackable: true, description: 'A stone out of the rock, worth cutting. A jeweller sets it in a ring or a pendant, and worn it favours one trade in the wearer.' },
