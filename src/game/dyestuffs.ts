...
export const DYES: DyeDef[] = [
  ...
  dye('scarlet', 'Scarlet', 'scarlet', '#c8452f', '#8e2a1a', 'strawberry', 10, 22, 'Strawberries boiled down hard. A shouting red, and the hardest of them to get right.'),
  ...
  dye('verdigris', 'Verdigris', 'green', '#4b7a4a', '#325232', 'mint', 8, 18, 'Mint over copper. A deep leaf green.'),
