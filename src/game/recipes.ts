...
export const RECIPES: Recipe[] = [
  ...
  // Stonework
  { id: 'make_stone_brick', category: 'Stonework', result: 'stone_brick', count: 2, inputs: [{ item: 'rock_shards' }], tool: 'chisel', skill: 'stonecutting', label: 'Chisel stone brick', verb: 'chiselling', baseTime: 6, stamina: 0.04, difficulty: 12, done: 'You chisel two stone bricks out of the rock.', fail: 'The shard splits the wrong way. You fail to make a brick.' },
  { id: 'make_slate_brick', category: 'Stonework', result: 'slate_brick', count: 2, inputs: [{ item: 'slate_shards' }], tool: 'chisel', skill: 'stonecutting', label: 'Chisel slate brick', verb: 'chiselling', baseTime: 6, stamina: 0.04, difficulty: 12, done: 'You chisel two slate bricks out of the block.', fail: 'The slate flakes apart. You fail to make a brick.' },
  { id: 'make_marble_brick', category: 'Stonework', result: 'marble_brick', count: 2, inputs: [{ item: 'marble_shards' }], tool: 'chisel', skill: 'stonecutting', label: 'Chisel marble brick', verb: 'chiselling', baseTime: 6, stamina: 0.04, difficulty: 12, done: 'You chisel two marble bricks out of the block.', fail: 'The marble cracks. You fail to make a brick.' },
  { id: 'make_sandstone_brick', category: 'Stonework', result: 'sandstone_brick', count: 2, inputs: [{ item: 'sandstone_shards' }], tool: 'chisel', skill: 'stonecutting', label: 'Chisel sandstone brick', verb: 'chiselling', baseTime: 6, stamina: 0.04, difficulty: 12, done: 'You chisel two sandstone bricks out of the block.', fail: 'The sandstone crumbles. You fail to make a brick.' },
  ...
  { id: 'make_mortar', category: 'Stonework', result: 'mortar', count: 5, inputs: [{ item: 'clay' }, { item: 'sand' }], skill: 'masonry', label: 'Mix mortar', verb: 'mixing mortar', baseTime: 4, stamina: 0.03, done: 'You mix clay and sand into five lots of mortar.' },
  // Clay & thatch
  ...
  { id: 'set_focus', category: 'Jewellery', result: 'focus', inputs: [{ item: 'gem' }, { item: 'silver_lump' }], tool: 'file', skill: 'jewellery', material: 'gem', label: 'Set a focus', verb: 'setting a focus', baseTime: 14, stamina: 0.04, difficulty: 20, done: 'You draw the silver up into four claws and close them over the stone.', fail: 'The claw goes over too far, the stone splits, and there is silver and grit in your palm.', consumeOnFail: true },
