...
for (const [fn, v] of [
  ...
  /* And how far past what is shown the clock stirs every round, how often it stirs the rest, and a crated one. */
  ['stir_slack', STIR_SLACK], ['stir_coarse_every', STIR_COARSE_EVERY], ['stored_settle', STORED_SETTLE],
  /* And how long a worker with nothing to do waits before it looks again. */
  ['worker_rest_first', WORKER_REST_FIRST], ['worker_rest_every', WORKER_REST_EVERY], ['worker_rest_most', WORKER_REST_MOST],
