-- The dispatcher, finished.
--
-- Three hundred and seventy-three of three hundred and seventy-three. Every
-- action in the game now has a performer behind it, which means `act_ported`
-- will never again be the reason anything is refused — and `rpc_unported()`
